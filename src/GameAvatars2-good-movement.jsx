...
const MiniSoccer = () => {
  ...
  const diffConfig = {
    easy: { aiSpeed: 2.2, playerSpeed: 4.5, ballFriction: 0.98, aiIntelligence: 0.4, shootForce: 18 },
    medium: { aiSpeed: 3.8, playerSpeed: 5.0, ballFriction: 0.985, aiIntelligence: 0.75, shootForce: 21 },
    hard: { aiSpeed: 5.5, playerSpeed: 6.0, ballFriction: 0.99, aiIntelligence: 1.0, shootForce: 25 }
  };
